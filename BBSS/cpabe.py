...
def encrypt_key(id, policy):
    p = subprocess.run(['cpabe-enc','/home/user/Light_Med/BBSS/pub_key', '/home/user/Light_Med/BBSS/Symkeys/{}_key.txt'.format(id), '{}'.format(policy)])
def encrypt_text(dir, policy):
    p = subprocess.run(['cpabe-enc','/home/user/Light_Med/BBSS/pub_key', '/home/user/Light_Med/BBSS/{}'.format(dir), policy])
...
def decrypt(file, key):
    p = subprocess.run(['cpabe-dec', '-k','/home/user/Light_Med/BBSS/pub_key', '/home/user/Light_Med/BBSS/cpabe_keys/{}_priv_key'.format(key), '/home/user/Light_Med/BBSS/Symkeys/{}_key.txt.cpabe'.format(file)])
    #p = subprocess.call(["cpabe-dec", "-k","pub_key", "./cpabe_keys/DO00000_priv_key", "{}".format(file)])
def keygen(id,policy):
    p = subprocess.run(['cpabe-keygen','-o','/home/user/Light_Med/BBSS/cpabe_keys/{}_priv_key'.format(id),'/home/user/Light_Med/BBSS/pub_key','/home/user/Light_Med/BBSS/master_key', '{}'.format(policy)])
