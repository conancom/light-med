...
def main():
   ...
   # Enc at IoT (DO) => AES +   big constant * (Multiplication of all policies + 1 - size of policy) + High Power of G
   # Enc at Cloud (TKeyGen) => CP-ABE -> Whole Key
   # Dec at Cloud (FDecrypt) =>  CP-ABE 2/3 of policies
   # Dec at DU => CP-ABE 1/3 of policies # Since they are both equal + AES Dec
